...
#
# Synkar från /home/johan/cloud-storage/onedrive/coding till NAS.
# --delete tar bort filer vid målet som ej finns i källan.
#

Source=$HOME/cloud-storage/onedrive/coding
...
echo "coding, "`date` "till NAS ($Nas_Success)" >> ~/Backup_dates_disks.txt
