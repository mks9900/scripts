...
echo "Backup av darktable kördes den" `date` "till NAS ($Nas_Success), Lacie1Tb ($Lacie_1T_Success), ExtDiskTwo ($ExtDiskTwo), Dropbox ($Dropbox_Success), GoogleDrive ($GoogleDrive)" >> ~/backup_dates_types.txt
