...
/usr/bin/tar -czvf $HOME/dot_git_configs.tar.gz $HOME/.gitconfig*
...
echo " $SourceSSH till $TargetSSH: $Nas_Success"
echo " $SourceSSH till $OnedriveSSH: $Onedrive_Success"
echo " $SourceGit till $TargetGit: $Nas_Success"
echo " $SourceGit till $OnedriveGit: $Onedrive_Success"
echo "=========================================================="
