...
Source=$HOME/.config/RawTherapee5-dev
...
echo "Backup av RawTherapee kördes den" `date` "till NAS ($Nas_Success), Lacie1Tb ($Lacie_1T_Success), ExtDiskTwo ($ExtDiskTwo)" >> ~/backup_dates_types.txt
