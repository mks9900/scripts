...
#
# Synkar från /home/johan/cloud-storage/onedrive/scripts till NAS.
# --delete tar bort filer vid målet som ej finns i källan.
#

Source=$HOME/onedrive_privat/scripts
...
echo "scripts, "`date` "till NAS ($Nas_Success)" >> ~/onedrive_privat/backup_dates_disks.txt
