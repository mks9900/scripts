...
select enhet in Alla NAS Lacie1T; do
    case $enhet in
	Alla ) echo "Säkerhetskopierar till alla backup-enheter.";
		   ...
		   echo "=========================================================="
		   /usr/bin/rsync -hrvz --progress --delete $Source $Lacie_1T
		   Lacie_1T_Success=1; 
	       else
		   echo "=========================================================="
	...
	NAS ) echo "=========================================================="
	      ...
	      # Synka till ng-nas om den är monterad, annars avbryt:
	       if [ "$DevSource" = "$Try" ]; then
		   /usr/bin/rsync -arvz --delete $Source $NgNas
		   Nas_Success=1; 
	       else
...
echo " $Source till $Lacie_1000: $Lacie_1T_Success"
echo "=========================================================="
