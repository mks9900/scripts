...
# /Volumes/"NIKON Z 6"/DCIM/100NCZ_6
Target=/home/johanthor/tmp/import-z6-raw/
# /Volumes/Raw_photos/raws/imports
PhotoPath=/home/johanthor/onedrive_privat/Pictures/Raw/
# /Volumes/Raw_photos/raws/
...
# TODO: Felhantering om det redan finns kataloger/filer i import som är samma som på kortet!
  ...
  #Amount="$(echo "$Amount2"|sed -e "s/\(\.[0-9]\).*/\1/g")"
	...
	echo "\nNu är alla filer kopierade från minneskortet till flyttbara disken."
