...
# Definitioner:
#
source=$HOME/rt-floatingtools_source
cd $source
baseTargetPath="$HOME/rt-floatingtools"
...
select svar in  Ja Nej; do
	...
	Ja ) echo "=====================================================================================" 
	     ...
	     echo "====================================================================" 
	     cmake -DCMAKE_BUILD_TYPE="$buildType" -DPROC_TARGET_NUMBER="2" -DBUILD_BUNDLE="ON" -DBINDIR="." -DDATADIR="." -DCACHE_NAME_SUFFIX="4" ..
	     echo "====================================================================================="
	     break;;
...
#echo
#echo "====================================================================================="
#echo "Döper om den gamla binär-katalogen så att den sparas undan:"
